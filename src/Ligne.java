...
public class Ligne {
	...
	public Ligne(String ligne) throws Exception{
		...
		else throw new ArrayIndexOutOfBoundsException("Ligne non valide et ignor�e");
	}
	...
	public String detectionTickets(String tickets){
		...
		if (listTickets.length() != 0){
			...
			this.tickets = listTickets.substring(0,listTickets.length()-2); // Suppression de la derni�re virgule
